...
class SportsEventCard extends StatelessWidget {
 ...
 SportsEventCard({
              ...
              children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        AppSizes.gapW8,
                        Text(
                          startDate.toLocal().toString().split(' ')[0], // Format as needed
                          style: theme.textTheme.bodyMedium?.copyWith(
                            color: AppColors.primaryBlue,
                            fontWeight: FontWeight.w600,
                          ),
                        ...
                        AppSizes.gapW8,
                        Text(
                      startDate.toLocal().toString().split(' ')[1].substring(0, 5), 
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: AppColors.slate500,
                      ),
                    ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      registrationUrl.isEmpty ? "Coming Soon":'Register Now',
                      style: TextStyle(
                        fontSize: AppSizes.x16,
                        fontWeight: FontWeight.w900,
                        letterSpacing: 0.5,
  ...
  void onRegister() {
    // Implement registration logic, e.g., navigate to registrationUrl
  }
  ...
  factory SportsEventCard.fromJson(Map<String, dynamic> json) {
  return SportsEventCard(
    // Use .toString() to safely handle cases where the backend might send a non-string
    location: json['location']?.toString() ?? 'Unknown Location',
    description: json['description']?.toString() ?? '',
    tagline: json['tagline']?.toString() ?? '',
    
    // Explicitly cast lists
    format: json['format'] != null ? List<String>.from(json['format']) : [],
    
    sport: json['sport']?.toString() ?? 'Unknown Sport',
    
    // DateTime parsing remains the same
    ...
    venue: json['venue']?.toString() ?? 'TBD',
    coordinator: json['coordinator']?.toString(),
    coCoordinator: json['coCoordinator']?.toString(),
    rulebookUrl: json['rulebookUrl']?.toString(),
    posterUrl: json['posterUrl']?.toString(),
    
    // Handle the null 'registrationUrl' from your JSON snippet
