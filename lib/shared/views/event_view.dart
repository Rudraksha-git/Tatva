...
class CulturalEventView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  CustomAppBar(
        ...
        onNotificationTap: (){Get.to(() => AllAnnouncementsView());},
        notificationCount: 3,
      ),
      body: Column(
        children: [
                ...
                itemBuilder: (context, index) {
                  ...
                  String displayDate =
                      event.startDate != null
                          ...
                          : 'TBA';
                  String displayTime =
                      event.schedule?.time ?? event.schedule?.prelims ?? 'TBA';
  ...
  String _getPlaceholderImage(String? category) {
    ...
    if (cat.contains('dance'))
      return 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad';
